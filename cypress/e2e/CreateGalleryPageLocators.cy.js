...
describe("Create Gallery test cases", ()=>{
    ...
    it("Create gallery with invalid URL - without domain name", ()=>{
        cy.get(locators.gallery.createGalleryTitle).clear().type("naslov");
    ...
    it("Create gallery with invalid URL -missing .jpg, .png, .jpeg",()=>{
        ...
        cy.get(locators.gallery.createGalleryTitle).clear().type("naslov");
        cy.get(locators.gallery.createURL).clear().type("https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01_2x3");
        cy.get (locators.gallery.createGallerySubmitButton).click();

    })

    it ("Create gallery with invalid title- less than 2 characters",()=>{
        cy.get(locators.gallery.createGalleryTitle).clear().type("n");
        cy.get(locators.gallery.createURL).clear().type("https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01_2x3.jpg");
        cy.get (locators.gallery.createGallerySubmitButton).click();
    ...
    it("Create gallery with wrong URL placement", ()=>{
        cy.get(locators.gallery.createGalleryTitle).clear().type("naslov");
        cy.get (locators.gallery.createGalleryDescription).clear().type("https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01_2x3.jpg");
        cy.get(locators.gallery.createURL).clear().type("naslov");
        cy.get (locators.gallery.createGallerySubmitButton).click();
    ...
    it("Create gallery with title and description- using unicode", ()=>{     
        cy.get(locators.gallery.createGalleryTitle).clear().type("Ššš");
    ...
    it("Create gallery with description and title using digits", ()=>{     
        cy.get(locators.gallery.createGalleryTitle).clear().type("111");
        cy.get (locators.gallery.createGalleryDescription).clear().type("222");
        cy.get(locators.gallery.createURL).clear().type("https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01_2x3.jpg");
        cy.get (locators.gallery.createGallerySubmitButton).click();
    ...
    it("Create gallery with description and title using digits", ()=>{     
        cy.get(locators.gallery.createGalleryTitle).clear().type("%%%");
        cy.get (locators.gallery.createGalleryDescription).clear().type("^^^");
        cy.get(locators.gallery.createURL).clear().type("https://i.natgeofe.com/n/82fddbcc-4cbb-4373-bf72-dbc30068be60/drill-monkey-01_2x3.jpg");
        cy.get (locators.gallery.createGallerySubmitButton).click();
    ...
    it("Create gallery with png files", ()=>{     
        cy.get(locators.gallery.createGalleryTitle).clear().type("naslov");
        cy.get (locators.gallery.createGalleryDescription).clear().type("opis");
        cy.get(locators.gallery.createURL).clear().type("https://cdn.pixabay.com/photo/2017/02/09/21/08/wings-2053515__340.png");
        cy.get (locators.gallery.createGallerySubmitButton).click();
